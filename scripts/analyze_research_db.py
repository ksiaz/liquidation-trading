...
def analyze_node_lifecycle(node_id: Optional[str] = None):
...
def analyze_primitives(symbol: Optional[str] = None):
...
def analyze_liquidations(hours: Optional[int] = None):
...
def main():
    ...
    if args.nodes or args.node_id:
        analyze_node_lifecycle(args.node_id)

    if args.primitives:
        analyze_primitives(args.symbol)

    if args.liquidations:
        analyze_liquidations(args.hours)
