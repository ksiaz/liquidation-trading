...
_SCHEMA_DIR = os.path.join(_PROJECT_ROOT, 'data_pipeline', 'schema')
...
class TestSchemaDefinitions:
    ...
    def test_schema_file_exists(self):
        ...
        schema_path = os.path.join(_SCHEMA_DIR, '001_initial_schema.sql')
...
class TestSchemaDocumentation:
    ...
    def test_readme_exists(self):
        ...
        readme_path = os.path.join(_SCHEMA_DIR, 'README.md')
