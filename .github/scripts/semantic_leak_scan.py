...
EXCEPTIONS: Dict[str, Dict[int, str]] = {
    'runtime/m6_executor.py': {
        ...
        150: "Instance variable assignment: config initialization",
        151: "Instance variable assignment: logger initialization",
        152: "Instance variable assignment: state initialization",
        156: "Loop: iterating over configured symbols",
        164: "Instance variable assignment: policy adapter setup",
        167: "Instance variable assignment: entry scorer setup",
        170: "Instance variable assignment: capital manager setup",
        173: "Instance variable assignment: risk config setup",
        187: "Instance variable assignment: exchange adapter setup",
        190: "Instance variable assignment: orchestrator setup",
        220: "State transition: halt state on error",
        227: "State transition: running state on start",
